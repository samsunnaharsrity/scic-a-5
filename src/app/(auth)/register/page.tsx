      ...
      <style>{`
       .reg-bg {
        ...
        .reg-bg::before {
          ...
          border-radius: 50%;
          background: radial-gradient(circle, rgba(109,76,255,.15) 0%, transparent 70%);
          pointer-events: none;
        }
        .reg-bg::after {
          content: '';
        ...
        .logo-mark {
          ...
          box-shadow: box-shadow: 0 10px 30px rgba(109,76,255,.35);
        }
        .card-header h1 {
        ...
        .field input:focus {
          border-color: #6D4CFF;
          background: #ffffff;
          box-shadow: 0 0 0 3px rgba(109,76,255,.15);
        }
        ...
        .role-card.selected .role-icon { background:linear-gradient(
        135deg,
        rgba(109,76,255,.15),
        rgba(139,92,246,.15)
        ); }
        ...
        .role-card.selected .role-title { color:#6D4CFF; }
        ...
        .role-card.selected .role-dot {
          border-color:#6D4CFF;
        background:#6D4CFF;
        box-shadow:0 0 10px rgba(109,76,255,.45);
        }
        ...
        .btn-submit {
          ...
          margin-top: 0.5rem;
          box-shadow:0 8px 24px rgba(109,76,255,.35);
        }
        .btn-submit::before {
        ...
        .btn-submit:hover:not(:disabled) { transform: translateY(-1px); box-shadow:0 12px 30px rgba(109,76,255,.45); }
